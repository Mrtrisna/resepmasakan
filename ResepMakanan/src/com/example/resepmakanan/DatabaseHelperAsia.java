...
public class DatabaseHelperAsia extends SQLiteAssetHelper
{
	private static final String		DB_NAME		= "ciaubella";
	private static final int		DB_VER		= 1;

	private static final String		TB_DATA		= "asia";
	public static final String		COL_ID		= "kd_asia";
	...
	private static DatabaseHelperAsia	dbInstance;
	private static SQLiteDatabase	db;

	private DatabaseHelperAsia(Context context)
	{
		super(context, DB_NAME, null, DB_VER);
	}

	public static DatabaseHelperAsia getInstance(Context context)
	{
		if (dbInstance == null)
		{
			dbInstance = new DatabaseHelperAsia(context);
