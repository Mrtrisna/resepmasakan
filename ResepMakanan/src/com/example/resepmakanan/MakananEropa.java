...
public class MakananEropa extends Activity implements TextWatcher, OnItemClickListener{
	private EditText					search;
	private ListView					lv;
	private DatabaseHelperEropa		dbHelper;
	...
	protected void onCreate(Bundle savedInstanceState){
		...
		dbHelper = DatabaseHelperEropa.getInstance(this);
		setData();
