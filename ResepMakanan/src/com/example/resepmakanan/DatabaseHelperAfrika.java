...
public class DatabaseHelperAfrika extends SQLiteAssetHelper
{
	private static final String		DB_NAME		= "ciaubella";
	private static final int		DB_VER		= 1;

	private static final String		TB_DATA		= "afrika";
	public static final String		COL_ID		= "kd_afrika";
	...
	private static DatabaseHelperAfrika	dbInstance;
	private static SQLiteDatabase	db;

	private DatabaseHelperAfrika(Context context)
	{
		super(context, DB_NAME, null, DB_VER);
	}

	public static DatabaseHelperAfrika getInstance(Context context)
	{
		if (dbInstance == null)
		{
			dbInstance = new DatabaseHelperAfrika(context);
