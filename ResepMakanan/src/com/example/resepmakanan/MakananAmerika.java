...
public class MakananAmerika extends Activity implements TextWatcher, OnItemClickListener{
	private EditText					search;
	private ListView					lv;
	private DatabaseHelperAmerika		dbHelper;
	...
	protected void onCreate(Bundle savedInstanceState){
		...
		dbHelper = DatabaseHelperAmerika.getInstance(this);
		setData();
