...
public class MakananAfrika extends Activity implements TextWatcher, OnItemClickListener{
	private EditText					search;
	private ListView					lv;
	private DatabaseHelperAfrika		dbHelper;
	...
	protected void onCreate(Bundle savedInstanceState){
		...
		dbHelper = DatabaseHelperAfrika.getInstance(this);
		setData();
