...
public class DatabaseHelperEropa extends SQLiteAssetHelper
{
	private static final String		DB_NAME		= "ciaubella";
	private static final int		DB_VER		= 1;

	private static final String		TB_DATA		= "eropa";
	public static final String		COL_ID		= "kd_eropa";
	...
	private static DatabaseHelperEropa	dbInstance;
	private static SQLiteDatabase	db;

	private DatabaseHelperEropa(Context context)
	{
		super(context, DB_NAME, null, DB_VER);
	}

	public static DatabaseHelperEropa getInstance(Context context)
	{
		if (dbInstance == null)
		{
			dbInstance = new DatabaseHelperEropa(context);
